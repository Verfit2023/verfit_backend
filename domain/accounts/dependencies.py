"""
# JWT, 비밀번호 해싱 및 기타 유틸리티 함수 구현

비밀번호 해싱 및 검증: 사용자의 비밀번호를 안전하게 저장하고 검증하기 위한 함수들
JWT 토큰 생성 및 검증: 사용자 인증을 위해 JWT 토큰을 생성하고, 요청에서 전달된 토큰을 검증하는 함수들
OAuth2PasswordBearer: FastAPI의 보안 유틸리티로, 토큰 URL을 지정하여 사용
"""
